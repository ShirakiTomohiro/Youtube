...
class YoutubeController extends Controller
{
    ...
    {
        $result = Movie2::All();
        return view('admin.news.play2', ['result' => $result]);
    }
    
    
    public function edit(Request $request)
    {
        $movie2 = Movie2::find($request->user_id);
       
        return view('admin.news.edit' ,['movie_form' => $movie2]);
    ...
    {
        $this->validate($request, Movie2::$rules);
...
return view('admin.news.play', ['response' => $response]);
    ...
    {
       define('AIzaSyDjdXsXm2J4-K78FdXCcroM8ZNbtpu-ENU', ''); // APIキー (Google Developer Consoleから取得し���ものをセットしてください)
